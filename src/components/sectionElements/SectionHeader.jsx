...
export default function SectionHeader(props) {
  ...
  return (
    ...
    >
      <div className="py-[4px] font-semibold px-[8px] text-paragraph2 rounded-2xl inline-block bg-[#682121] bg-opacity-10 mb-[16px]">
        <p className="text-primary">{miniTitle}</p>
      </div>
      <h1
