...
export default function Quadrada({ appDownloadButtons, LightMode }) {
  return (
    <div
      className={`w-full bg-center bg-repeat font-mainFont bg-gradient-to-b ${
        LightMode
          ? "from-bgSectionLight to-white"
          : "from-bgSectionDark to-black"
      }`}
      id="home"
    >
        ...
        <div className="w-full text-secondary justify-evenly">
          ...
          <div className="flex flex-col-reverse gap-[40px] desktop1:flex-row desktop1:justify-between mx-auto w-[90%] max-w-[1215px] items-center pb-[64px] pt-[40px] desktop1:pt-[68px] desktop1:pb-[96px]">
            <div className="flex flex-col w-full desktop1:w-[50%] desktop1:mr-[20px]">
              <MotionDivDownToUp>
                <div
                  className={`flex justify-center w-auto text-center desktop1:justify-start desktop1:text-left font-secondFont text-paragraph4 ${
                ...
                >
                  <p
                    ...
                    } text-paragraph2 rounded-md px-[16px] py-[6px] inline-block`}
                  >
              ...
              <MotionDivDownToUp>
                <div
                  ...
                  } flex justify-center desktop1:justify-start font-bold leading-[40px] phone3:leading-[42px] tablet1:leading-[70px] desktop1:leading-[60px] desktop2:leading-[65px] text-center desktop1:text-left text-title4 phone2:text-title5 phone3:text-title5 tablet1:text-title6`}
                >
              ...
              <MotionDivDownToUp>
                <div
                  className={`flex justify-center w-full text-center desktop1:text-left desktop1:justify-start font-secondFont text-paragraph4 phone3:text-paragraph5 ${
                  ...
                  <div className="flex justify-center desktop1:justify-start">
                    <div className="flex flex-col items-center desktop1:flex-row text-primary">
                      ...
                      <p
                        className={`text-${
                          LightMode ? "black" : "white"
                        } ml-[10px] text-center mt-[12px] desktop1:mt-0`}
                      >
