...
function FullImg({ obs }) {
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-[#111318] to-[#141821] z-0"></div>
  ...
  >
    ...
    <div className="absolute inset-0 bg-gradient-to-b from-black/40 to-[#141821] z-20"></div>
