...
import bgImg from "../../landingPage/hero/bgHero.webp";

const whatsappContactLink = `https://wa.me/` + `${links.ctaWhatsapp}`;

export default function CtaSolidCenter() {
  return (
    <div
      className="bg-left bg-cover desktop1:bg-fixed desktop1:bg-left"
      id="contact"
    >
      <div className="flex flex-col justify-center w-full bg-opacity-0 bg-primary">
        ...
        <div className="flex justify-center w-full bg-orange-500 bg-opacity-0">
          <SectionContent>
            <div className="flex justify-center w-full  font-mainFont py-[40px] tablet1:py-[64px] desktop1:py-[96px]">
              <div className="w-[90%] max-w-[1215px] flex flex-row items-end justify-center desktop2:justify-start">
                <div className=" flex flex-col w-full  justify-evenly items-center desktop1:items-center gap-[32px]">
                  <h1 className="w-full leading-[58px] text-secondary text-center desktop1:text-center text-title4 font-poppins desktop1:text-title5 desktop2:text-title6 flex justify-center">
                    <MotionDivUpToDown className="desktop1:w-full [text-shadow:_2px_3px_0_rgb(0_0_0_/_50%)]">
