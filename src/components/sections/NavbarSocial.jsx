        ...
        <Navbar>
          ...
          >
            <img
              ...
              className={`${
                scrolling
                  ? "  w-[20%] max-w-[60%] tablet2:w-[20%] tablet2:max-w-[70%] desktop1:w-[20%] desktop2:w-[30%] transition-all duration-1000 "
                  : "w-[30%] tablet1:w-[30%] tablet2:w-[35%] desktop1:w-[35%] desktop2:w-[40%] transition-all duration-1000 "
              } tablet3:mb-0`}
            />
          </ScrollLink>
