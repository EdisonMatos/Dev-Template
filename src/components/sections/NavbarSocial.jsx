          ...
          >
            <img
              ...
              className={`bg-transparent max-h-[90px] ${
                scrolling
                  ? "bg-white p-3 rounded-md w-[50%] phone3:w-[40%] tablet1:w-[40%] tablet2:w-[40%] desktop1:w-[50%] desktop2:w-[60%]"
                  : "bg-white p-3 rounded-md my-[20px] w-[80%] phone2:w-[70%] phone3:w-[60%] tablet1:w-[60%] tablet2:w-[70%] desktop2:w-[80%]"
