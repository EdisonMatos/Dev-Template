...
export const infos = {
  ...
  instagramProfile: "negreirosadvocaciaa", // Sem o @
...
const content = {
  texts: {
    ...
    features: {
      ...
      title: "Excelência jurídica em diversas áreas do Direito",
      subtitle:
        "Transformamos desafios legais em vitórias reais e estratégicas.",
      imgFeatures: imgFeatures,
      imgDivisor: imgDivisor,
      card1: {
        img: featuresImg1,
        title: "Penal e Processo Penal",
        subtitle: "Defesa em acusações criminais e revisões processuais.",
        description: (
          <div>
            A_Definir
            <br />
      ...
      card2: {
        img: featuresImg2,
        title: "Direito Cível",
        subtitle: "Resolução de conflitos contratuais e indenizatórios.",
        description: (
          <div>
            A_Definir
            <br />
      ...
      card3: {
        ...
        subtitle: "Atuação em divórcios, guarda, pensão e sucessões.",
        description: (
          <div>
            A_Definir <br />
            <br />
      ...
      card4: {
        ...
        subtitle:
          "Reclamações trabalhistas, rescisões e direitos do trabalhador.",
        description: (
          <div>
            A_Definir
            <br />
