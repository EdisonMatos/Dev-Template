      ...
      <div className="flex justify-center desktop1:justify-start">
        <div className="w-[90%] desktop1:w-[352px] flex flex-col justify-end ">
          <img
            ...
            className="mb-[57px] w-full desktop1:w-[325px]"
          ></img>
          <h1 className="text-[28px] text-center desktop1:text-[45.5px] mb-[23px] desktop1:w-[355px] font-black leading-[40px]">
            REDES SOCIAIS
          </h1>
          <div className="flex gap-[20px] phone3:gap-[0px] items-center flex-col phone3:flex-row justify-between mb-[32px] desktop1:mb-[61px]">
            <ButtonsFooter label="Instagram" />
            <ButtonsFooter label="Whatsapp" />
          </div>
        </div>
      </div>
      <div className=" italic text-[15px] h-[86px] flex items-center text-center w-full justify-center opacity-80">
