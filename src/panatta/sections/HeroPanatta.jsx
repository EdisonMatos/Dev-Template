...
export default function HeroPanatta() {
  return (
    <div className="relative w-full">
      ...
      <img
        className="absolute phone1:bottom-[70%] phone1:right-[20%] phone1:w-[60%] phone2:bottom-[69%] tablet1:w-[40%] tablet1:bottom-[65%] tablet1:right-[30%] desktop1:right-[35%] desktop1:bottom-[78%] desktop1:h-auto desktop1:w-[30%] desktop2:right-[35%] desktop2:bottom-[73%] desktop2:h-auto desktop2:w-[30%] spin"
        src={Ball}
        alt="Bola girando"
      />
      ...
      <div className="mb-[112px] flex flex-col justify-center items-center">
        <img
          className="relative phone1:mt-[350px] phone1:w-[300px] phone1:h-[200px] phone1:px-[2px] desktop1:mb-4 desktop1:px-[20px] desktop1:mt-[400px] desktop1:w-[1085.58px] desktop1:h-[415.65px]"
          src={ImgHero}
